...
write.table(go_degree_bait,go_enrichment_bait,sep="\t", row.name=F)
write.table(go_degree_prey,go_enrichment_prey,sep="\t", row.name=F)
write.table(do_degree_bait,do_enrichment_bait,sep="\t", row.name=F)
write.table(do_degree_prey,do_enrichment_prey,sep="\t", row.name=F)
