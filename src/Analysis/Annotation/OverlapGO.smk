...
rule get_go_accumulation:
    ...
    run:
        ...
        cum_columns = ['ji_bp', 'ji_cc', 'ji_mf', 'intersect_bp',
                       'intersect_cc', 'intersect_mf']

        get_cumulative_sum(
            go_df,
            value_column="lower_bound_pod",
            cumulative_columns=cum_columns
        ).to_csv(
...
rule plot_go_accumulation:
    input:
        "work_folder/analysis/GO/cumulative/POD_abundance_jaccard_greater.csv",
        "work_folder/analysis/GO/cumulative/POD_abundance_jaccard_lesser.csv",
        "work_folder/analysis/GO/cumulative/POD_ms_y2h_jaccard_greater.csv",
        "work_folder/analysis/GO/cumulative/POD_ms_y2h_jaccard_lesser.csv",
        "work_folder/analysis/GO/ra_pod_vs_go_terms.csv",
        "work_folder/analysis/GO/n_studies_go_terms.csv"
    output:
