...
rule generate_test_validation_test:
    input:
        interaction_data = "work_folder/subsets/{dataset}_{network_type}_limit_{config['positive_max']}_pos.csv",
        max_negative = "work_folder/subsets/{dataset}_{network_type}_limit_{config['negative_max']}_neg.csv"
    output:
...
rule define_max_sets:
    ...
    output:
        max_positive = "work_folder/subsets/{dataset}_{network_type}_limit_{config['positive_max']}_pos.csv",
        max_negative = "work_folder/subsets/{dataset}_{network_type}_limit_{config['negative_max']}_neg.csv"
    log:
