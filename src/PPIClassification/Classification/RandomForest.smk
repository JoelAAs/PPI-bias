rule random_forest:
    input:
        ...
        validation_ppi_data_pos=f"work_folder{pn}/subsets/validation/balanced/{{dataset}}_pos.csv",
        validation_ppi_data_neg=f"work_folder{pn}/subsets/validation/balanced/{{dataset}}_neg.csv",
